...
function curvyObject() {
    ...
    var boxPaddingTop 		= jQuery(this.box).css("paddingTop");
	var boxPaddingBottom 	= jQuery(this.box).css("paddingBottom");
	var boxPaddingLeft 		= jQuery(this.box).css("paddingLeft");
	var boxPaddingRight 	= jQuery(this.box).css("paddingRight");
    ...
    this.applyCorners = function() {
		...
		if(this.settings.autoPad == true && (this.boxPaddingTop > 0 || this.boxPaddingBottom > 0 || this.boxPaddingLeft > 0 || this.boxPaddingRight > 0)) {
            ...
            jQuery(contentContainer).css("position","relative").html(this.boxContent).addClass = "autoPadDiv";
            ...
            if(topMaxRadius < this.boxPaddingTop)
				...
				jQuery(contentContainer).css("padding-top",this.boxPaddingTop);
            if(botMaxRadius < this.boxPaddingBottom)
				jQuery(contentContainer).css("padding-bottom",botPadding);
			else 
				jQuery(contentContainer).css("padding-bottom",this.boxPaddingBottom);
			jQuery(contentContainer).css({"padding-left":this.boxPaddingLeft,"padding-right":this.boxPaddingRight});
            ...
            if(i > -1 < 4) {
                ...
                if(!this.settings[cc]) {
                    if(((cc == "tr" || cc == "tl") && this.topContainer != null) || ((cc == "br" || cc == "bl") && this.bottomContainer != null)) {
						...
						if(this.bgImage == "")
                        	jQuery(newCorner).css("background-color",this.boxColour);
                        else
							jQuery(newCorner).css("background-image",this.bgImage).css("background-color",this.boxColour);;
						
                        switch(cc)
                        {
                            case "tl":
								jQuery(newCorner).css({height:topMaxRadius - this.borderWidth,"margin-right":this.settings.tr.radius - (this.borderWidth*2), "border-left":this.borderString,"border-top":this.borderString,left:-this.borderWidth + "px", "background-repeat":jQuery(this.box).css("background-repeat"), "background-position":this.borderWidth + "px 0px"});
                            break;
                            case "tr":
								jQuery(newCorner).css({height:topMaxRadius - this.borderWidth,"margin-left":this.settings.tl.radius - (this.borderWidth*2), "border-right":this.borderString,"border-top":this.borderString,left:this.borderWidth + "px", "background-repeat":jQuery(this.box).css("background-repeat"), "background-position":"-" + (topMaxRadius + this.borderWidth) + "px 0px"});
                            break;
                            case "bl":
								if(topMaxRadius>0)
									jQuery(newCorner).css({height:botMaxRadius - this.borderWidth,"margin-right":this.settings.br.radius - (this.borderWidth*2), "border-left":this.borderString,"border-bottom":this.borderString,left:-this.borderWidth + "px", "background-repeat":jQuery(this.box).css("background-repeat"), "background-position":"0px -" + (jQuery(this.box).height() + topMaxRadius  - this.borderWidth +1) + "px" });
								else
									jQuery(newCorner).css({height:botMaxRadius - this.borderWidth,"margin-right":this.settings.br.radius - (this.borderWidth*2), "border-left":this.borderString,"border-bottom":this.borderString,left:-this.borderWidth + "px", "background-repeat":jQuery(this.box).css("background-repeat"), "background-position":"0px -" + (jQuery(this.box).height()) + "px" });
                            break;
                            case "br":
								if(topMaxRadius>0)
									jQuery(newCorner).css({height:botMaxRadius - this.borderWidth,"margin-left":this.settings.bl.radius - (this.borderWidth*2), "border-right":this.borderString,"border-bottom":this.borderString,left:this.borderWidth + "px", "background-repeat":jQuery(this.box).css("background-repeat"),  "background-position":"-" + this.settings.bl.radius + this.borderWidth + "px -" + (jQuery(this.box).height() + topMaxRadius  - this.borderWidth + 1) + "px" });
								else
									jQuery(newCorner).css({height:botMaxRadius - this.borderWidth,"margin-left":this.settings.bl.radius - (this.borderWidth*2), "border-right":this.borderString,"border-bottom":this.borderString,left:this.borderWidth + "px", "background-repeat":jQuery(this.box).css("background-repeat"),  "background-position":"-" + this.settings.bl.radius + this.borderWidth + "px -" + (jQuery(this.box).height()) + "px" });
                            break;
                        };
                    ...
                    if(cc != "br") {
                        for(var t = 0, k = newCorner.childNodes.length; t < k; t++) {
                            ...
                            var pixelBarTop 		= strip_px(jQuery(pixelBar).css("top"));
                            var pixelBarLeft 		= strip_px(jQuery(pixelBar).css("left"));
                            var pixelBarHeight 		= strip_px(jQuery(pixelBar).css("height"));
                            ...
                            switch(cc) {
                                ...
                                case "bl":
									...
									// Could this be magic?
									if(topMaxRadius>0)
										jQuery(pixelBar).css("background-position", "-" + Math.abs((this.settings[cc].radius -pixelBarLeft -1) - this.borderWidth) + "px -" + Math.abs((jQuery(this.box).height() + topMaxRadius - this.borderWidth + 1)) + "px");
									else
										jQuery(pixelBar).css("background-position", "-" + Math.abs((this.settings[cc].radius -pixelBarLeft -1) - this.borderWidth) + "px -" + Math.abs((jQuery(this.box).height())) + "px");
        ...
        for(z in radiusDiff) {
            if(z == "t" || z == "b") {
                if(radiusDiff[z]) {
				  ...
				  {
					  case "tl":
						jQuery(newFiller).css({"bottom":"0","left":"0","border-left":this.borderString});
						this.topContainer.appendChild(newFiller);
						break;

					  case "tr":
					  	jQuery(newFiller).css({"bottom":"0","right":"0","border-right":this.borderString});
						this.topContainer.appendChild(newFiller);
						break;

					  case "bl":
					  	jQuery(newFiller).css({"top":"0","left":"0","border-left":this.borderString});
						this.bottomContainer.appendChild(newFiller);
						break;

					  case "br":
					  	jQuery(newFiller).css({"top":"0","right":"0","border-right":this.borderString});
						this.bottomContainer.appendChild(newFiller);
						break;
				  }
			};
			...
			jQuery(newFillerBar).css({	position:"relative","font-size":"1px",overflow:"hidden","background-color":this.boxColour,"background-image":this.bgImage,"background-repeat":jQuery(this.box).css("background-repeat")});
			switch(z) {
                    case "t":
                    if(this.topContainer) {
						...
						jQuery(this.box).css("background-position", "0px -" + (topMaxRadius - this.borderWidth +1) + "px"); 
                    }; 
                    break;
                    case "b":
                    if(this.bottomContainer) {
                        if(this.settings.bl.radius && this.settings.br.radius) {
                            ...
                            if(this.bgImage != "" && topMaxRadius>0)
								jQuery(newFillerBar).css("background-position","-" + (this.settings.bl.radius - this.borderWidth) + "px -" + (jQuery(this.box).height() + topMaxRadius - this.borderWidth + 1) + "px");
							else
								jQuery(newFillerBar).css("background-position","-" + (this.settings.bl.radius - this.borderWidth) + "px -" + (jQuery(this.box).height() ) + "px");
    ...
    this.drawPixel = function(intx, inty, colour, transAmount, height, newCorner, image, cornerRadius) {
        ...
        if(image == -1 && this.bgImage != "") {
			...
			if(topMaxRadius>0)
				jQuery(pixel).css("background-position","-" + ((this.boxWidth - cornerRadius - this.borderWidth)+ intx) + "px -" + ((jQuery(this.box).height() + topMaxRadius  - this.borderWidth )-inty) + "px");
			else
				jQuery(pixel).css("background-position","-" + ((this.boxWidth - cornerRadius - this.borderWidth)+ intx) + "px -" + ((jQuery(this.box).height() )-inty) + "px");
					
			jQuery(pixel).css({
						 "background-image":this.bgImage,
						 "background-repeat":jQuery(this.box).css("background-repeat"),
						 "background-color":colour,
						 "background-position":"-" + ((this.boxWidth - cornerRadius - this.borderWidth)+ intx) + "px -" + ((jQuery(this.box).height() + topMaxRadius  - this.borderWidth )-inty) + "px"
			});
        }
        else
        {
